...
def read_namespace(
    ...
    # This is added to allow using the same rootnamespace name in lookup dirs for frankennav.
    # We will revert back to the official branch when this is fixed in the upstream.
